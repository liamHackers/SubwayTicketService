					...
					<div class="content">
						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>公告管理</span></a>
								<ul class="sub-menu">
									<li class="active"><a href="findAllNotice.do">查看公告</a></li>
									...
									<table style="clear: both"
										...
										<tbody>
											...
											<c:forEach var="u" items="${notice}">
												<tr>
													<td><a
														href="getMainNoticeToAdmin.do?noticeID=${u.noticeID}">${u.title}</a></td>
													<td><a>${u.time}</a></td>
													<td><a>${u.pusher}</a></td>
													<td><a
														onclick="ajaxTest(${u.noticeID},${page.pageNo});"><button
																mid type="submit" class="btn btn-primary">删除</button></a></td>
												</tr>
											</c:forEach>
...
#color-switcher .color.gray {
	...
	<script type="text/javascript">
		...
		function ajaxTest(noticeID, pageNo) {
			$.ajax({
				data : {
					'noticeID' : noticeID
				},
				...
				success : function(data) {
					alert(data.msg);
					location.href = "findAllNotice.do?pageNo=" + pageNo;
				}
			});
		}
	</script>
