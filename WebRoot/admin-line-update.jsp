...
<%
	...
	String htmlData = request.getParameter("time") != null ? request
			.getParameter("time") : "";
%>
<!DOCTYPE html>
<html lang="en">
...
<script>
	KindEditor.ready(function(K) {
		var editor1 = K.create('textarea[name="time"]', {
	...
	<div id="cl-wrapper">
					...
					<div class="content">
						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-list-alt"></i><span>线路信息</span></a>
								<ul class="sub-menu">
									<li class="active"><a href="admin-line-update.jsp">修改线路信息</a></li>
								</ul></li>
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont">
				<div class="page-head">
					<ol class="breadcrumb">
						<li><a href="admin-index.jsp">主界面</a></li>
						<li><a>线路信息</a></li>
						<li class="active">修改线路信息</li>
					</ol>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="block-flat">
							...
							<div class="mail" style="height:800px">
								...
								<form name="example" method="post" action="updLine.do">
									车站ID：<input name="stationID" type="text" style="width:245px;"><br>
									<br> 车站英文名：<input name="enName" type="text"
										style="width:220px;"><br>
									<br> 车站中文名：<input name="stationName" type="text"
										style="width:220px;"><br>
									<br> 出口信息（以，分隔）：<input name="exitinfo" type="text"
										style="width:634px;"><br>
									<br> 公交站信息（以，分隔）：<input name="businfo" type="text"
										style="width:620px;"><br>
									<br> 选择线路：<select name="lineID">
										...
										<option value="9">广佛线</option>
									</select><br>
									<br>
									<h3>首末班车时间</h3>
									<hr>
									<textarea name="time" cols="100" rows="8"
										style="width:1000px;height:300px;visibility:hidden;">
