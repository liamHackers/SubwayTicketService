						...
						<ul class="cl-vnavigation">
							<li><a href="#"><i class="fa fa-home"></i><span>首页</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="getNewNotice.do"><span
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="cl-mcont aside">
				<div class="page-aside email">
					<div class="">
						<div class="content">
							...
							<p class="description">（点击你感兴趣的话题）</p>
						</div>
						<div class="mail-nav collapse">
							<ul class="nav nav-pills nav-stacked ">
								<c:forEach var="u" items="${notice}">
									<li><a href="getMainNotice.do?noticeID=${u.noticeID}"><i
											class="fa fa-star-o"></i> ${u.title}</a></li>
								</c:forEach>
							</ul>
							...
							<div class="compose">
								...
								<c:choose>
									<c:when test="${page.pageNo!=1}">
										<a class="btn btn-flat btn-primary"
											href="findAllNotice.do?pageNo=${page.previousPageNo }">上一页</a>
									</c:when>
									<c:otherwise>
								...
								<c:choose>
									<c:when test="${page.pageNo != page.totalPages}">
										<a class="btn btn-flat btn-primary"
											href="findAllNotice.do?pageNo=${page.nextPageNo }">下一页</a>
									</c:when>
									<c:otherwise>
				...
				<div>
					<div class="message">
						<div class="head">
							<h3>${pointnotice.title}
								<span><i class="fa fa-inbox"></i><i class="fa fa-reply"></i></span>
							</h3>
							<h4>
								<span id="hits"></span> <span class="test"></span>
							</h4>
							<span><i class="fa fa-star"></i> ${pointnotice.time}</span>
						</div>
						<div class="mail" style="height:800px">
							<p>${pointnotice.content1 }</p>
						</div>
					</div>
				</div>
			</div>
