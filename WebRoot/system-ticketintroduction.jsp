...
<div id="cl-wrapper">
          ...
          <ul class="cl-vnavigation">
            <li><a href="#"><i class="fa fa-home"></i><span>首页</span></a>
              <ul class="sub-menu">
                ...
                <li  ><a href="getNewNotice.do"><span class="label label-primary pull-right">New</span>公告信息</a></li>
              </ul>
            </li>
            ...
            <li><a href="#"><i class="fa fa-table"></i><span>客服中心</span></a>
              <ul class="sub-menu">
                <li  ><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${cService[0].cserviceQQ }&site=qq&menu=yes">客服一</a></li>
                <li  ><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${cService[1].cserviceQQ }&site=qq&menu=yes">客服二</a></li>
            ...
            <!-- <li><a href="#"><i class="fa fa-map-marker nav-icon"></i><span>地图</span></a>
             ...
             <li  ><a href="check-line.jsp"><i class="fa fa-text-height"></i><span>查询路线</span></a></li>
            ...
            <li><a href="#"><i class="fa fa-file"></i><span>更多功能</span></a>
              <ul class="sub-menu">
				...
				<li  ><a href="http://weibo.com/p/1006065618105325/home?from=page_100606&mod=TAB" target="_black">官方微博</a></li>
                <li  ><a href="more-friendsline.jsp">友情链接</a></li>
                <li ><a href="more-app.jsp">APP下载</a></li>
              </ul>
            </li>
            <li class=""><a href="javascript:;"><i class="fa fa-folder-open"></i><span class="title">系统帮助</span><span class="arrow "></span></a>
              <ul class="sub-menu">
                <li class="active"><a href="ticketintroduction.do">中国中车票务简介</a></li>
      ...
      <div class="navbar-collapse">
        <ul class="nav navbar-nav navbar-right user-nav">
          <li class="dropdown profile_menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar"  src="${user.photoPath }" height="40" width="40" /><span>${user.name }</span> <b class="caret"></b></a>
  ...
  <div class="cl-mcont">		<div class="page-head">
			<ol class="breadcrumb">
			  <li><a href="notice_query.do">首页</a></li>
			  <li>系统帮助</li>
			  <li class="active">中国中车票务简介</li>
			</ol>
		</div>	
		
    
	<div class="cl-mcont"><h3 class="text-center">中国中车票务简介</h3>
	</div>
	
	<div class="message">
     
      <div class="mail" style="height:800px">
        ${ticketintroduction.content1}
      </div>
