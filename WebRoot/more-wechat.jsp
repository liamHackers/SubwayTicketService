	...
	<div id="cl-wrapper">
              ...
              <ul class="sub-menu">
                ...
                <li  ><a href="#vector-maps.jsp">个人定位</a></li>
							...
							<li><a href="#"><i class="fa fa-file"></i><span>更多功能</span></a>
								<ul class="sub-menu">
									<li class="active"><a href="more-wechat.jsp">官方微信</a></li>
									<li><a
		...
		<div class="container-fluid" id="pcont">
			...
			<div class="content">
				...
				<img src="images/chat.png" class="img-responsive" alt="Cinque Terre"
					width="1900" height="374">
				<h3 align="center">扫描关注官方微信！</h3>
			</div>
