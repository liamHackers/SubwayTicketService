						...
						<ul class="cl-vnavigation">
							<li><a href="#"><i class="fa fa-home"></i><span>用户管理</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="findDel.do">删除用户</a></li>
										...
										<tbody>
											...
											<c:forEach var="users" items="${requestScope.users}">
												<tr>
													...
													<td>${users.balance }</td>
													<td align="center"><a
														href="delUser.do?userID=${users.userID }">删除</a>&nbsp;&nbsp;&nbsp;
											...
											<div class="compose">
												<c:choose>
													<c:when test="${page.pageNo!=1}">
														<a class="btn btn-flat btn-primary"
															href="findDel.do?pageNo=${page.previousPageNo }">上一页</a>
													</c:when>
													<c:otherwise>
												...
												<c:choose>
													<c:when test="${page.pageNo != page.totalPages}">
														<a class="btn btn-flat btn-primary"
															href="findDel.do?pageNo=${page.nextPageNo }">下一页</a>
													</c:when>
													<c:otherwise>
