						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>线路信息</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="findLineTwo.do">二号线</a></li>
			...
			<div class="cl-mcont">
				<div class="page-head">
					<ol class="breadcrumb">
						<li><a href="#">首页</a></li>
						<li><a href="#">线路信息</a></li>
						<li class="active">二号线</li>
					</ol>
				</div>

				<ul class="cbp_tmtimeline">

					<c:forEach var="linetwo" items="${linetwo}">
						<li><time class="cbp_tmtime" datetime="enName 站点">
								<span>${linetwo.enName}</span> <span>${linetwo.stationName}</span>
							</time>
							<div class="cbp_tmicon cbp_tmicon-phone"></div>
							<div class="cbp_tmlabel">
								<h2>${linetwo.stationName}</h2>
								<p>
									首末班车时间<br>${linetwo.time}<br>
								<h4 class="panel-title">
									<i class="fa fa-angle-right"></i> 站点资讯
								</h4>
								出口：${linetwo.exitinfo}<br> 公交站：${linetwo.businfo}<br>
								</p>
							</div></li>
					</c:forEach>
