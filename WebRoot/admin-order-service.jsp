						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>其他</span></a>
								<ul class="sub-menu">
									...
									<!-- <li class="active"><a href="admin-order-service.jsp">修改客服</a></li> -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="block-flat">
							<div class="header">
								<h3>修改客服</h3>
								<a><button mid type="submit" class="btn btn-primary">增加</button></a>
								</td>
							</div>
							<div class="content">
								<div class="table-responsive">
									...
									<table style="clear: both"
										...
										<tbody>
											...
											<tr>
												<td>000A</td>
												<td><li><a href="#">zckefu1</a></li></td>
												<td><a>客服一</a></td>
												<td><a>5.0</a></td>
												<td><a><button mid type="submit"
															class="btn btn-primary">删除</button></a></td>
											</tr>
											<tr>
												<td>000B</td>
												<td><li><a href="#">zckefu2</a></li></td>
												<td><a>客服二</a></td>
												<td><a>4.9</a></td>
												<td><a><button mid type="submit"
															class="btn btn-primary">删除</button></a></td>
											...
											<div class="compose">
												<a class="btn btn-flat btn-primary" href="#">上一页</a> <a
													class="btn btn-flat btn-primary" href="#">下一页</a>
											</div>
											</div>
