						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-desktop"></i><span>新闻管理</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="admin-news-publish.jsp">发布新闻</a></li>
					...
					<div class="col-md-12">
						<div class="block-flat">
							...
							<div class="mail" style="height:800px">
								...
								<form name="example" method="post" action="addNew.do">
									新闻要点：<input name="point" type="text" style="width:420px;"><br>
									<br> 新闻标题：<input name="title" type="text"
										style="width:420px;"><br>
										<input type="hidden" name="pusher"/>
									<h3>新闻内容</h3>
