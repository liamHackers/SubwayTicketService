						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-desktop"></i><span>个人中心</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="personal-updatepassword.jsp">修改密码</a></li>
				...
				<div class="row wizard-row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control" placeholder="请输入新密码">
										...
										<!--  <div class="form-group">
                  <label class="col-sm-3 control-label">请输入手机号码</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="输入正确的手机号码">
                  </div>
                </div>	 -->
										<div class="form-group">
									...
									<div class="step-pane" id="step2">
										...
										<div class="form-group">
											<div class="col-sm-offset-2 col-sm-10">
												...
												<a onclick="ajaxTest()"><button data-wizard="#wizard1"
													class="btn btn-primary wizard-next">
													下一步<i class="fa fa-caret-right"></i>
												</button></a>
											</div>
...
#color-switcher .color.gray {
	...
	<script type="text/javascript">
		...
		function ajaxTest() {
		var userID=document.getID.userID.value;
		var password=document.updatePassword.password.value;
			...
			$.ajax({
				...
				error : function(data) {
					...
					alert("修改密码失败！");
					location.href = "personal-updatepassword.jsp";
				},
