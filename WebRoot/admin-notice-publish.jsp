						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>公告管理</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="admin-notice-publish.jsp">发布公告</a></li>
								</ul></li>
					...
					<div class="col-md-12">
						<div class="block-flat">
							...
							<div class="mail" style="height:800px">
								...
								<form name="example" method="post" action="addNotice.do">
									公告标题：<input name="title" type="text" style="width:420px;"><br>
