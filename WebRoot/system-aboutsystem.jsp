						...
						<ul class="cl-vnavigation">
							...
							<li class=""><a href="javascript:;"><i
								...
								<ul class="sub-menu">
									...
									<li class="active"><a href="system.do">关于系统</a></li>
								</ul></li>
						...
						<ul class="nav navbar-nav navbar-right user-nav">
							<li class="dropdown profile_menu"><a href="#"
								...
								<ul class="dropdown-menu">
									<li><a href="personal-information.jsp">个人信息</a></li>
									<li><a href="returnTicket.do">购票信息</a></li>
									<li class="divider"></li>
			...
			<div class="cl-mcont">
				...
				<div class="message">
					<div class="head">
						<h3>地铁网络自助取票系统</h3>
						<h4>
							版本号：1.0.1<span><a href="#"><i class="fa fa-star"></i></a>
								Designed by Four-Five</span>
						</h4>
					</div>
					<div class="mail">${system.content1}</div>
