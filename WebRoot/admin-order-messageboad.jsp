					...
					<div class="content">
						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>其他</span></a>
								<ul class="sub-menu">
									<li class="active"><a href="findPageAllMessage.do">查看留言板</a></li>
								...
								<div class="table-responsive">
									...
									<table style="clear: both"
										...
										<tbody>
											...
											<c:forEach var="u" items="${messageBoad}">
												<tr>
													<td><a>${u.pusher1}</a></td>
													<td><a>${u.time1}</a></td>
													<td><a>${u.content1}</a></td>
												</tr>
											</c:forEach>
											...
											<div class="compose">
												<c:choose>
													<c:when test="${page.pageNo<1}">
														<a class="btn btn-flat btn-primary"
															href="findPageAllMessage.do?pageNo=${page.previousPageNo }">上一页</a>
													</c:when>
													<c:otherwise>
												...
												<c:choose>
													<c:when test="${page.pageNo != page.totalPages}">
														<a class="btn btn-flat btn-primary"
															href="findPageAllMessage.do?pageNo=${page.nextPageNo }">下一页</a>
													</c:when>
													<c:otherwise>
