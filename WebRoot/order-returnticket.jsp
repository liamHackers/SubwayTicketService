						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-list-alt"></i><span>订单管理</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="returnTicket.do">退票</a></li>
								</ul></li>
										...
										<tbody>
											...
											<c:forEach var="orders" items="${requestScope.orders}">
												<tr>
													...
													<td>${orders.status }</td>
													<td align="center"><a
														href="delOrder.do?orderID=${orders.orderID }">退票</a>&nbsp;&nbsp;&nbsp;
											...
											<div class="compose">
												<c:choose>
													<c:when test="${page.pageNo!=1}">
														<a class="btn btn-flat btn-primary"
															href="returnTicket.do?pageNo=${page.previousPageNo }">上一页</a>
													</c:when>
													<c:otherwise>
												...
												<c:choose>
													<c:when test="${page.pageNo != page.totalPages}">
														<a class="btn btn-flat btn-primary"
															href="returnTicket.do?pageNo=${page.nextPageNo }">下一页</a>
													</c:when>
													<c:otherwise>
