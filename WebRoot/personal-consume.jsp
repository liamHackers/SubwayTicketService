...
<!--  <script type="text/javascript">
		function del(userID){
			$.get("delUser.do?userID="+ userID,function(data){
			alter(data.result);
						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-desktop"></i><span>个人中心</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="ticketRecord.do">购票记录</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="block-flat">
							...
							<div class="content">
								<div id="button" class="table-responsive">



									<form action="recharge.do" method="post" name="rechargeform">
											...
											<div class="modal-dialog custom-width">
												<div class="modal-content">
													<div class="modal-body">
														<div align="center" id="liantuimg"></div>
													</div>
													<div class="modal-footer">
														...
														<input type="hidden" name="email" id="email"
															value="${user.email }"> <a
															onclick="testsendemail()"><button type="submit"
																class="btn btn-primary btn-flat" data-dismiss="modal">To
																Email</button></a>
													</div>
												</div>
												<!-- /.modal-content -->
										...
										<table style="clear: both"
											class="table table-bordered table-striped" id="order">
											<tbody>
												...
												<c:forEach var="orders" items="${orders }">
													<tr>
														...
														<td>${orders.orderID }<div id="getorderid"></div></td>
														<td>${orders.start }</td>
														<td>${orders.terminal }</td>
														<td>${orders.price }</td>
														<td>${orders.status }</td>
														<td><a onclick="testliantuimge(${orders.orderID } )"><button
																	data-toggle="modal" data-target="#md-custom"
																	type="button" class="btn btn-primary btn-flat">查看二维码</button></a></td>
													</tr>
												</c:forEach>
												...
												<div class="compose">
													<c:choose>
														<c:when test="${page.pageNo!=1}">
															<a class="btn btn-flat btn-primary"
																href="ticketRecord.do?pageNo=${page.previousPageNo }">上一页</a>
														</c:when>
														<c:otherwise>
													...
													<c:choose>
														<c:when test="${page.pageNo != page.totalPages}">
															<a class="btn btn-flat btn-primary"
																href="ticketRecord.do?pageNo=${page.nextPageNo }">下一页</a>
														</c:when>
														<c:otherwise>
...
#color-switcher .color.gray {
	...
	<script type="text/javascript">
		...
		function testliantuimge(orderID) {
			/* var orderID1=document.getElementById("orderid").value; */
			var orderID1 = orderID;
			var result = "";
			result += "<img src='http://qr.topscan.com/api.php?text="+orderID1+ "'  width='200' height='200' alt='加载中....'> <input type='hidden' id='orderid' name='orderid' value='"+orderID1+"'/>";
			$("#liantuimg").html(result);
		}
