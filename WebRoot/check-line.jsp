...
<link rel="stylesheet" type="text/css"
	href="js/jquery.codemirror/lib/codemirror.css">
<link rel="stylesheet" type="text/css"
	href="js/jquery.codemirror/theme/ambiance.css">
<link rel="stylesheet" type="text/css"
	href="js/jquery.vectormaps/jquery-jvectormap-1.2.2.css" media="screen" />
			...
			<div class="cl-navblock">
              ...
              <ul class="sub-menu">
                ...
                <li  ><a href="#vector-maps.jsp">个人定位</a></li>
							...
							<li class="active"><a href="check-line.jsp"><i
					...
					<tr>
						<td>
							<p style="margin-top: -70px;margin-left: -10px">
								<iframe
									src="http://map.baidu.com/subways/index.html?c=guangzhou&ccode=257"
									frameborder=0 height="800" marginwidth=0 marginheight=0
									hspace=0 vspace=0 scrolling=no width="1250"></iframe>
						</td>
					</tr>
				</table>
