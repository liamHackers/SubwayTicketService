...
<link rel="stylesheet" type="text/css"
	href="js/bootstrap.wysihtml5/dist/bootstrap3-wysihtml5.min.css">
<link rel="stylesheet" type="text/css"
	href="js/bootstrap.summernote/dist/summernote.css" />
	...
	<div id="cl-wrapper">
						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-table"></i><span>客户中心</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="messageBoad_query.do">留言板</a></li>
								</ul></li>
		...
		<div class="container-fluid" id="pcont">
						...
						<ul class="nav navbar-nav navbar-right user-nav">
							<li class="dropdown profile_menu"><a href="#"
								class="dropdown-toggle" data-toggle="dropdown"><img
									alt="Avatar"  src="${user.photoPath }" height="40" width="40" /><span>${user.name }</span> <b class="caret"></b></a>
			...
			<div class="cl-mcont">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="block-flat">
							...
							<div class="content inline-editable" contenteditable="true">
								<c:forEach var="n" items="${messageBoad}">
									<h4>${n.content1 }</h4>
									<p>留言时间：${n.time1 }</p>
									<h4>${n.content2 }</h4>
									<p>留言时间：${n.time2 }&nbsp;&nbsp;&nbsp;&nbsp;回复人：${n.pusher2 }</p>
								</c:forEach>
								<font color="#FF0000">为了维护文明网络环境，请大家文明用语</font>
					...
					<div class="col-md-12">
						...
						<div class="block-flat">
							...
							<div class="mail" style="height:800px">
								<br>
								<form name="example" method="post" action="addMessageboad.do">
									<h3>留言内容</h3>
									<hr>
				...
				<!-- Right Chat-->
				<nav
					class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right side-chat">
					<div class="header">
						<h3>Chat</h3>
					</div>
					...
					<div class="content">
						...
						<ul class="nav nav-pills nav-stacked contacts">
							<li class="online"><a href="#"><i class="fa fa-circle-o"></i>
									Jaime Garzon</a></li>
							<li class="outside"><a href="#"><i
									class="fa fa-circle-o"></i> Dave Grohl</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i> Victor
									Jara</a></li>
						</ul>

						<p class="title">Work</p>
						<ul class="nav nav-pills nav-stacked contacts">
							<li><a href="#"><i class="fa fa-circle-o"></i> Ansel
									Adams</a></li>
...
#color-switcher .color.gray {
	background: #afb5b8;
		...
		"></script>
				...
				<script type="text/javascript"
					src="js/bootstrap.summernote/dist/summernote.min.js"></script>
				<script type="text/javascript"
					src="js/bootstrap.wysihtml5/dist/wysihtml5-0.3.0.js"></script>
				<script type="text/javascript"
					src="js/bootstrap.wysihtml5/dist/bootstrap3-wysihtml5.all.min.js"></script>
		...
		$(document).ready(function() {
			...
			$('#summernote').summernote();
				...
				<script type="text/javascript" s rc="js/jquery.flot/jquery.flot.js"></script>
				<script type="text/javascript"
