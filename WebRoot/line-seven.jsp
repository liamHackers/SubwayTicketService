						...
						<ul class="cl-vnavigation">
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>线路信息</span></a>
								<ul class="sub-menu">
									...
									<li class="active"><a href="line-seven.jsp">七号线</a></li>
...
#color-switcher .color.gray {
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			skycons.add("widget1_1", Skycons.WIND);
			skycons.add("widget1_2", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget1_3", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget1_4", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget2_1", Skycons.SNOW);
			skycons.add("widget2_2", Skycons.SNOW);
			skycons.add("widget2_3", Skycons.SNOW);
			skycons.add("widget2_4", Skycons.SNOW);
			skycons.add("widget3_1", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget3_2", Skycons.CLOUDY);
			skycons.add("widget3_3", Skycons.RAIN);
			skycons.add("widget3_4", Skycons.CLOUDY);
			skycons.add("widget4_1", Skycons.CLOUDY);
			skycons.add("widget4_2", Skycons.CLOUDY);
			skycons.add("widget4_3", Skycons.CLOUDY);
			skycons.add("widget4_4", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget5_1", Skycons.FOG);
			skycons.add("widget5_2", Skycons.FOG);
			skycons.add("widget5_3", Skycons.SNOW);
			skycons.add("widget5_4", Skycons.FOG);
			skycons.add("widget6_1", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget6_2", Skycons.CLOUDY);
			skycons.add("widget6_3", Skycons.RAIN);
			skycons.add("widget6_4", Skycons.CLOUDY);
			skycons.add("widget7_1", Skycons.CLEAR_DAY);
			skycons.add("widget7_2", Skycons.RAIN);
			skycons.add("widget7_3", Skycons.RAIN);
			skycons.add("widget7_4", Skycons.RAIN);
			skycons.add("widget8_1", Skycons.CLOUDY);
			skycons.add("widget8_2", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget8_3", Skycons.PARTLY_CLOUDY_DAY);
			skycons.add("widget8_4", Skycons.PARTLY_CLOUDY_DAY);
			skycons.play();
		});
	</script>
