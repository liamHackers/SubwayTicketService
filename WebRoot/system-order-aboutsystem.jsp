					...
					<div class="content">
						...
						<ul class="cl-vnavigation">
							<li><a href="#"><i class="fa fa-home"></i><span>用户管理</span></a>
								<ul class="sub-menu">
									<li><a href="admin-user-check.jsp">查询用户</a></li>
									<li><a href="admin-user-del.jsp">删除用户</a></li>
									<li><a href="admin-user-order.jsp">用户订单信息</a></li>
								</ul></li>
							<li><a href="#"><i class="fa fa-desktop"></i><span>新闻管理</span></a>
								<ul class="sub-menu">
									<li><a href="admin-news-check.jsp">查看新闻</a></li>
									<li><a href="admin-news-publish.jsp">发布新闻</a></li>
									<li><a href="admin-news-del.jsp">删除新闻</a></li>

								</ul></li>
							<li><a href="#"><i class="fa fa-smile-o"></i><span>公告管理</span></a>
								<ul class="sub-menu">
									<li><a href="admin-notice-check.jsp">查看公告</a></li>
									<li><a href="admin-notice-publish.jsp">发布公告</a></li>
									<li><a href="admin-notice-del.jsp">删除公告</a></li>
								</ul></li>
							...
							<li><a href="#"><i class="fa fa-smile-o"></i><span>其他</span></a>
								<ul class="sub-menu">
									<li><a href="admin-order-friendsline.jsp">修改友情链接</a></li>
									<li class="active"><a href="admin-order-ticketintroduction.jsp">修改票务简介</a></li>
									<!-- <li><a href="admin-order-service.jsp">修改客服</a></li> -->
									<li><a href="admin-order-canpanyintroduction.jsp">修改公司简介</a></li>
									<li ><a href="admin-order-safe.jsp">修改安全须知</a></li>
					...
					<div class="col-md-12">
						<div class="block-flat">
							...
							<div class="mail" style="height:800px">
								<form name="example" method="post" action="addSystem.do">
